      ...
      <div class="authentication-inner py-4">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="mb-2">
              Introduce tu correo y te enviaremos instrucciones para restablecer
              tu contraseña
            </p>

            <div v-if="status" class="text-center text-success m-0">
              {{ status }}
            </div>

            <form id="formAuthentication" class="mb-3" @submit.prevent="submit">
              <div class="mb-3">
                <label for="email" value="Email" class="form-label mt-1"
                  >Email</label
                >
                <input
                  id="email"
